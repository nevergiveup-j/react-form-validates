  ...
  return function (Component) {
    return formWrapper(_react2.default.createClass({
      ...
      componentWillMount: function componentWillMount() {
        ...
        formContext = _extends({}, form);

        formContext.getFieldProps = function (name, option) {
          return form.getFieldProps(name, (0, _rules.replaceRules)(option));
        };
      },
      ...
      render: function render() {
        var _props = this.props,
            form = _props.form,
            other = _objectWithoutProperties(_props, ['form']);

        return _react2.default.createElement(Component, _extends({ form: formContext }, other));
      }
    }));
  };
};
